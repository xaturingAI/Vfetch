// vfetch.v - Enhanced V program for system information fetching with customizable logos
...
fn main() {
	...
	if os.args.len > 1 {
		if os.args[1] == '-l' || os.args[1] == '--logo' {
			if os.args.len > 2 {
				logo_choice = os.args[2]
			} else {
			...
			println('vfetch - System information tool with customizable logos')
