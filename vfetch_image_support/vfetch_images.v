// vfetch_images.v - V program with image support
...
// Handle image display (this would call a Nim program)
fn display_image(image_path string) {
	// In a real implementation, this would call a Nim program to display the image
	// For now, we'll just print a message
	println('Displaying image: ${image_path}')
	// This would execute: nim_display_image(image_path)
}
